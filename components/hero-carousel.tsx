...
const heroItems = [
  {
    ...
    buttonText: 'Shop Now',
    image1: '/marketplace/sewing-denim-jacket-buttons.png',
    image2: '/marketplace/young-teenage-boy-wearing-denim-outfit-1.png',
  },
  {
    ...
    buttonText: 'Explore',
    image1: '/marketplace/products/woman-cotton-dress.png',
    image2: '/marketplace/products/abstract-natural-pigmented-t-shirt.png',
  },
  {
    title: 'AUTUMN STYLES',
    subtitle: 'Warm & Cozy',
    ...
    buttonText: 'Discover',
    image1: '/marketplace/products/unisex-brown-sweater.png',
    image2: '/marketplace/products/woman-brown-set.png',
  },
];
