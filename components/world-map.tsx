...
export function WorldMap({ dots = [], lineColor = '#3A271D' }: MapProps) {
  ...
  return (
    <div className="w-full relative ">
      <Image src={`data:image/svg+xml;utf8,${encodeURIComponent(svgMap)}`} className="h-full w-full pointer-events-none select-none" alt="world map" height="495" width="1056" draggable={false} />
